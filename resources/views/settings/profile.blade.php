                    ...
                    <div class="offset-md-1 col-md-3">
                      <div class="form-group">
                          ...
                          <div class="fileinput fileinput-new" data-provides="fileinput">
                              ...
                              <div class="mt-2">
                              <span class="btn btn-success btn-file"><span class="fileinput-new">{{ $user->profile_picture ? 'Change Image' : 'Select Image'}}</span><span class="fileinput-exists">Change</span><input type="file" name="profile_picture" accept="image/*"></span>
